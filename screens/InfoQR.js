...
const InfoQR = (props) => {
    ...
    const [extintor, setExtintor] = useState(props.route.params.revision ? props.route.params.revision.extintor : ({
        ...
        terminal: null,
        ubicacion: null,
        ubicacion_detallada: null,
        ubicacion_exacta: null,
        tipo_agente: null,
        capacidad: null,
        capacidad_medida: null,
        fecha_recarga: null,
        fecha_proxima_recarga: null,
        fecha_prueba_hidrostatica: null,
        fecha_proxima_prueba_hidrostatica: null,
        peso_total: null,
        pintura: null,
        aro_protector_cilindro: null,
        golpes: null,
        placa_instruccion: null,
        tarjeta_recarga: null,
        etiqueta_codificacion: null,
        valvula: null,
        manija_superior: null,
        manija_inferior: null,
        pin_seguridad: null,
        sujetador: null,
        manometro: null,
        presion_manometro: null,
        boquilla: null,
        manguera: null,
        anillo_verificacion: null,
        corneta: null,
        senalizacion: null,
        soporte: null,
        demarcacion: null,
        tarjeta_inspeccion_mensual: null,
        observaciones: null
    }))
